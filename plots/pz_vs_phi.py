...
x, y = pp.Sz_rapidity_polarization(path, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
a, b = pp.Sz_rapidity_polarization(path2, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
c, d = pp.Sz_rapidity_polarization(path3, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
e, f = pp.Sz_rapidity_polarization(path4, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
g, h = pp.Sz_rapidity_polarization(path5, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
i, j = pp.Sz_rapidity_polarization(path6, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
k, l = pp.Sz_rapidity_polarization(path7, mass=1.115683, rap_cut=1, vorticity=False, global_integrals = False)
